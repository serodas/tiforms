...
from forms.views.documentos_usuarios_cme import DocumentosUsuariosCmeView
...
urlpatterns = [
    ...
    path(
        "documentos/usuarios/cme/",
        DocumentosUsuariosCmeView.as_view(),
        name="post-documentos-usuarios-cme",
    ),
